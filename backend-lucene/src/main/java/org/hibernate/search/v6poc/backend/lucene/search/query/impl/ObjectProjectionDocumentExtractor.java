...
class ObjectProjectionDocumentExtractor implements ProjectionDocumentExtractor {

	private static final ObjectProjectionDocumentExtractor INSTANCE = new ObjectProjectionDocumentExtractor();
	...
	static ObjectProjectionDocumentExtractor get() {
		return INSTANCE;
	}

	private ObjectProjectionDocumentExtractor() {
	}
