...
import org.hibernate.search.v6poc.backend.elasticsearch.document.model.impl.ElasticsearchFields;
...
class DiscriminatorMultiTenancyStrategyImpl implements MultiTenancyStrategy {
	...
	public void contributeToMapping(RootTypeMapping rootTypeMapping) {
		...
		idPropertyMapping.setIndex( IndexType.TRUE );
		...
		tenantIdPropertyMapping.setIndex( IndexType.TRUE );
