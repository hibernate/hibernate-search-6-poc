 ...
 */
package org.hibernate.search.v6poc.backend.elasticsearch;

import java.lang.invoke.MethodHandles;
import java.util.Optional;

import org.hibernate.search.v6poc.backend.document.model.dsl.IndexSchemaFieldContext;
import org.hibernate.search.v6poc.backend.document.model.dsl.IndexSchemaFieldContextExtension;
...
import org.hibernate.search.v6poc.backend.elasticsearch.search.dsl.sort.impl.ElasticsearchSearchSortContainerContextImpl;
...
import org.hibernate.search.v6poc.backend.elasticsearch.search.sort.impl.ElasticsearchSearchSortBuilder;
