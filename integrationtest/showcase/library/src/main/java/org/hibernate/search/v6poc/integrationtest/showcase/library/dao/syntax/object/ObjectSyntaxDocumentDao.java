...
class ObjectSyntaxDocumentDao extends DocumentDao {
	...
	public Optional<Book> getByIsbn(String isbnAsString) {
		...
		org.hibernate.search.v6poc.entity.orm.hibernate.FullTextSearchTarget<Book> target =
				fullTextSession.search( Book.class );

		org.hibernate.search.v6poc.entity.orm.hibernate.FullTextQuery<Book> query = target.query()
				.asEntities()
				.predicate(
