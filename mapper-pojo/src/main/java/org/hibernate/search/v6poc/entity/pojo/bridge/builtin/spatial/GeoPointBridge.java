...
import org.hibernate.search.v6poc.util.impl.common.StreamHelper;
...
public class GeoPointBridge implements TypeBridge, PropertyBridge {
	...
	public static class Builder implements
			AnnotationBridgeBuilder<GeoPointBridge, org.hibernate.search.v6poc.entity.pojo.bridge.builtin.spatial.annotation.GeoPointBridge> {
		...
		public void initialize(
				org.hibernate.search.v6poc.entity.pojo.bridge.builtin.spatial.annotation.GeoPointBridge annotation) {
