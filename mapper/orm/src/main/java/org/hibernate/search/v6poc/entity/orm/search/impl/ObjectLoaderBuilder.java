...
public class ObjectLoaderBuilder<O> {
	...
	private <T> ComposableObjectLoader<PojoReference, T> buildForSingleType(
		...
		// TODO Add support for other types of database retrieval and object lookup? See HSearch 5: org.hibernate.search.query.hibernate.impl.ObjectLoaderBuilder#getObjectInitializer
