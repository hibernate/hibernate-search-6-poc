...
import org.hibernate.search.v6poc.entity.orm.util.impl.Maps;
...
import org.hibernate.search.v6poc.entity.pojo.mapping.PojoWorker;
...
public class HibernateSearchContextService implements Service {
	...
	public HibernateOrmSearchManager getSearchManager(SessionImplementor sessionImplementor) {
		...
		if ( searchManager == null ) {
			...
			// Make sure we will ultimately close the search manager
